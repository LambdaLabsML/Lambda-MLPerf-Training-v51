...
## System run params
# DM: DGXNNODES was 1, increasing to 2 to see if we can dip under
# time limit problem by using 16 GPUs. 
export DGXNNODES=1
export DGXNGPU=8
...
# DM: This was 30 before. Increasing to allow lower limit of 8-16 B200s
export WALLTIME_RUNANDTIME=90  # measured: run_and_time.sh takes up to 20 minutes
